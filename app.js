...
const THEMES=[
  ...
  {id:'tech', keys:['powerbank','usb','iphone','samsung','bluetooth','speaker','cuffie','auricolari','earpod','airpod','smartwatch','caricabatter','caricatore','tech','tecnolog']}
];
...
const I18N={
  ...
  en:{
    ...
    emptyText:'Few items in this category. Change filter or go back to the quiz.',
...
const initialLang=new URLSearchParams(location.search).get('lang')||localStorage.getItem('gf-lang')||'en';
...
(function fromPin(){
  ...
  if(who && ['all','mamma','pap\u00e0','papa'].includes(who)){
